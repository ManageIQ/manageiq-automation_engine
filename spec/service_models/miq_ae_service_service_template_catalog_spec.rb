describe MiqAeMethodService::MiqAeServiceServiceTemplateCatalog do
  context "associations" do
    before do
      service_template_catalog = FactoryBot.create(:service_template_catalog)
    ...
    it "#service_templates" do
      service_template = FactoryBot.create(:service_template, :service_template_catalog_id => @service_service_template_catalog.id)
